...
app = FastAPI(
    ...
    version="2.2.0", # Podniesienie wersji po finalnej poprawce
)
...
# --- Narzędzie do czyszczenia odpowiedzi AI ---
...
# Upewniamy się, że ta linia to @app.post, co oznacza obsługę metody POST
...
# Upewniamy się, że ta linia to @app.post
